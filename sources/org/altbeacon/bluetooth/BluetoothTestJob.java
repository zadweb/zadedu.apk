...
public class BluetoothTestJob extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        this.mHandler.post(new Runnable() {
            /* class org.altbeacon.bluetooth.BluetoothTestJob.AnonymousClass1 */
            ...
            public void run() {
                ...
                if (!z2) {
                    String str = BluetoothTestJob.TAG;
                    LogManager.w(str, "Unknown test type:" + i + "  Exiting.", new Object[0]);
                }
