            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        ...
                        int max = Math.max(i12, i13 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int max2 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        ...
                        if (z2 || ViewCompat.getFitsSystemWindows(view)) {
                            ...
                            i9 = View.MeasureSpec.makeMeasureSpec(size - (this.mLastInsets.getSystemWindowInsetLeft() + this.mLastInsets.getSystemWindowInsetRight()), mode);
                            i8 = View.MeasureSpec.makeMeasureSpec(size2 - (this.mLastInsets.getSystemWindowInsetTop() + this.mLastInsets.getSystemWindowInsetBottom()), mode2);
                        }
                        behavior = layoutParams2.getBehavior();
                        if (behavior != null) {
                        ...
                        onMeasureChild(view, i9, i7, i8, 0);
                        int max3 = Math.max(i12, i13 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int max22 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        i17 = View.combineMeasuredStates(i11, view.getMeasuredState());
                        i15 = max3;
                        i16 = max22;
                    }
                ...
                onMeasureChild(view, i9, i7, i8, 0);
                int max32 = Math.max(i12, i13 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                int max222 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                i17 = View.combineMeasuredStates(i11, view.getMeasuredState());
                i15 = max32;
                i16 = max222;
            }
