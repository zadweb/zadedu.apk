...
public final class ExoPlayerWrapper {
    ...
    public long getCurrentPosition() {
        ...
        long max = Math.max(0L, this.mPlayer.getCurrentPosition());
        MediaItem currentMediaItem = this.mMediaItemQueue.getCurrentMediaItem();
    ...
    /* access modifiers changed from: package-private */
    public final class ComponentListener extends Player.DefaultEventListener implements AudioListener, MetadataOutput, VideoRendererEventListener, TextRenderer.Output {
    ...
    private static void updatePlayerAudioSessionId(Handler handler, final DefaultAudioSink defaultAudioSink, final int i) {
        handler.post(new Runnable() {
            /* class androidx.media2.player.exoplayer.ExoPlayerWrapper.AnonymousClass1 */
