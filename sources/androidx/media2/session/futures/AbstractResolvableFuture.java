...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public static final class Failure {
        static final Failure FALLBACK_INSTANCE = new Failure(new Throwable("Failure occurred while trying to finish a future.") {
            /* class androidx.media2.session.futures.AbstractResolvableFuture.Failure.AnonymousClass1 */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r4v0, types: [androidx.media2.session.futures.AbstractResolvableFuture<?>] */
    /* JADX WARN: Type inference failed for: r4v1, types: [androidx.media2.session.futures.AbstractResolvableFuture] */
    /* JADX WARN: Type inference failed for: r4v6, types: [androidx.media2.session.futures.AbstractResolvableFuture, androidx.media2.session.futures.AbstractResolvableFuture<V>] */
    /* JADX WARN: Type inference failed for: r3v0, types: [androidx.media2.session.futures.AbstractResolvableFuture$AtomicHelper] */
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        /* access modifiers changed from: package-private */
        @Override // androidx.media2.session.futures.AbstractResolvableFuture.AtomicHelper
