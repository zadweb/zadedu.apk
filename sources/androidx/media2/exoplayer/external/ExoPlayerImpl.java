...
public final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(Renderer[] rendererArr, TrackSelector trackSelector2, LoadControl loadControl, BandwidthMeter bandwidthMeter, Clock clock, Looper looper) {
        ...
        this.eventHandler = new Handler(looper) {
            /* class androidx.media2.exoplayer.external.ExoPlayerImpl.AnonymousClass1 */
    ...
    public void setPlayWhenReady(boolean z, boolean z2) {
        ...
        if (this.playWhenReady != z) {
            ...
            notifyListeners(new ExoPlayerImpl$$Lambda$0(z, this.playbackInfo.playbackState));
        }
    }
    ...
    public void handleEvent(Message message) {
        ...
        if (i == 0) {
            ...
            notifyListeners(new ExoPlayerImpl$$Lambda$5(exoPlaybackException));
        } else {
    ...
    private PlaybackInfo getResetPlaybackInfo(boolean z, boolean z2, int i) {
        ...
        return new PlaybackInfo(timeline, obj, mediaPeriodId, j2, j, i, false, z2 ? TrackGroupArray.EMPTY : this.playbackInfo.trackGroups, z2 ? this.emptyTrackSelectorResult : this.playbackInfo.trackSelectorResult, mediaPeriodId, j2, 0, j2);
    }
    ...
    private void updatePlaybackInfo(PlaybackInfo playbackInfo2, boolean z, int i, int i2, boolean z2) {
        ...
        notifyListeners(new PlaybackInfoUpdate(playbackInfo2, playbackInfo3, this.listeners, this.trackSelector, z, i, i2, z2, this.playWhenReady));
    }
