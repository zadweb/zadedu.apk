...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static final class DefaultBandwidthProvider implements BandwidthProvider {
        ...
        public long getAllocatedBandwidth() {
            long max = Math.max(0L, ((long) (((float) this.bandwidthMeter.getBitrateEstimate()) * this.bandwidthFraction)) - this.nonAllocatableBandwidth);
    ...
    public static long[][][] getAllocationCheckpoints(long[][] jArr) {
        ...
        setCheckpointValues(jArr2, 1, jArr, iArr2);
        int i2 = 2;
        while (true) {
            ...
            iArr2[i3] = iArr2[i3] + 1;
            setCheckpointValues(jArr2, i2, jArr, iArr2);
            i2++;
        }
