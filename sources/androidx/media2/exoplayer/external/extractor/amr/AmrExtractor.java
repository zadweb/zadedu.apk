...
public final class AmrExtractor implements Extractor {
    ...
    private void maybeOutputFormat() {
        if (!this.hasOutputFormat) {
            ...
            this.trackOutput.format(Format.createAudioSampleFormat(null, this.isWideBand ? "audio/amr-wb" : "audio/3gpp", null, -1, MAX_FRAME_SIZE_BYTES, 1, this.isWideBand ? 16000 : 8000, -1, null, null, 0, null));
        }
    }
