...
public final class MpegAudioHeader {
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        int i10 = 1152;
        if (i3 == 3) {
            i7 = ((((i2 == 3 ? BITRATE_V1_L1[i4 - 1] : BITRATE_V2_L1[i4 - 1]) * 12) / i8) + i9) * 4;
            i6 = 384;
        } else {
            int i11 = 144;
            if (i2 == 3) {
                i7 = (((i3 == 2 ? BITRATE_V1_L2[i4 - 1] : BITRATE_V1_L3[i4 - 1]) * 144) / i8) + i9;
                i6 = 1152;
            } else {
        ...
        mpegAudioHeader.setValues(i2, MIME_TYPE_BY_LAYER[3 - i3], i7, i8, ((i >> 6) & 3) == 3 ? 1 : 2, ((i7 * 8) * i8) / i6, i6);
        return true;
    }
