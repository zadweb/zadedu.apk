...
public final class MediaPeriodQueue {
        ...
        while (frontPeriod != null) {
            ...
            if (!areDurationsCompatible(mediaPeriodInfo2.durationUs, mediaPeriodInfo.durationUs)) {
                if (mediaPeriodInfo.durationUs == -9223372036854775807L) {
                    ...
                    j3 = frontPeriod.toRendererTime(mediaPeriodInfo.durationUs);
                }
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo) {
        ...
        } else if (mediaPeriodInfo.endPositionUs == -9223372036854775807L || mediaPeriodInfo.endPositionUs == Long.MIN_VALUE) {
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            ...
            return getMediaPeriodInfo(resolveMediaPeriodIdForAds(obj, j5, j3), j5, j5);
        }
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.id;
        ...
        if (mediaPeriodId.isAd()) {
            ...
            if (nextAdIndexToPlay >= adCountInAdGroup) {
                ...
                if (this.period.getAdGroupCount() == 1 && this.period.getAdGroupTimeUs(0) == 0) {
                    ...
                    Pair<Object, Long> periodPosition2 = timeline2.getPeriodPosition(window2, period2, period2.windowIndex, -9223372036854775807L, Math.max(0L, rendererOffset));
