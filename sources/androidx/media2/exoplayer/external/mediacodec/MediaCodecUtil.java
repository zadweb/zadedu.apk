...
public final class MediaCodecUtil {
    ...
    static {
        ...
        HEVC_CODEC_STRING_TO_PROFILE_LEVEL.put("L120", Integer.valueOf((int) d.fb));
    ...
    public static Pair<Integer, Integer> getCodecProfileAndLevel(String str) {
        ...
        switch (c) {
            ...
            case 2:
                return getVp9ProfileAndLevel(str, split);
            case 3:
            case 4:
                return getHevcProfileAndLevel(str, split);
            case 5:
            case 6:
                return getDolbyVisionProfileAndLevel(str, split);
            case 7:
                return getAacCodecProfileAndLevel(str, split);
            default:
                return null;
        }
    }
            ...
            for (int i = 0; i < codecCount; i++) {
                ...
                if (codecSupportedType != null) {
                    try {
                        ...
                        if (codecKey.tunneling || !isFeatureRequired) {
                            if (!codecKey.tunneling || isFeatureSupported) {
                                ...
                                if (codecKey.secure || !isFeatureRequired2) {
    ...
    private static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        if ("audio/raw".equals(str)) {
            if (Util.SDK_INT < 26 && Util.DEVICE.equals("R9") && list.size() == 1 && list.get(0).name.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                list.add(MediaCodecInfo.newInstance("OMX.google.raw.decoder", "audio/raw", null));
            }
