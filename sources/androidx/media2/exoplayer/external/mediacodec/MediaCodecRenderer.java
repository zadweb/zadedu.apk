...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    @Override // androidx.media2.exoplayer.external.RendererCapabilities, androidx.media2.exoplayer.external.BaseRenderer
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z, String str) {
            this(r2.toString(), th, format.sampleMimeType, z, str, Util.SDK_INT >= 21 ? getDiagnosticInfoV21(th) : null, null);
            String valueOf = String.valueOf(format);
