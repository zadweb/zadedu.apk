...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void measureHorizontal(int i, int i2) {
        ...
        if (z8 || (i32 != 0 && f2 > 0.0f)) {
            ...
            while (i36 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f5 > 0.0f) {
                        ...
                        if (layoutParams3.width == 0) {
                            ...
                            if (mode == 1073741824) {
                                ...
                                i34 = View.combineMeasuredStates(i34, virtualChildAt3.getMeasuredState() & DrawableConstants.CtaButton.BACKGROUND_COLOR);
                                f2 = f6;
                                i11 = i38;
                            }
                        } else {
                    ...
                    iArr[i412] = Math.max(iArr[i412], baseline);
                    iArr2[i412] = Math.max(iArr2[i412], measuredHeight2 - baseline);
                    z9 = z;
                    i33 = max;
                    f2 = f;
                }
        ...
        setMeasuredDimension(resolveSizeAndState | (i3 & DrawableConstants.CtaButton.BACKGROUND_COLOR), View.resolveSizeAndState(Math.max(i8 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i7, i3 << 16));
        if (z10) {
