...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment.mMaxState == Lifecycle.State.CREATED) {
            ...
            i5 = Math.min(i4, fragment.mMaxState.ordinal());
        }
        int i7 = i5;
        if (fragment.mState <= i7) {
                ...
                if (i8 != 0) {
                    ...
                    if (i7 > 0) {
                        ...
                        if (fragment.mSavedFragmentState != null) {
                            ...
                            Fragment fragment3 = getFragment(fragment.mSavedFragmentState, "android:target_state");
            ...
            if (i7 < 1) {
                ...
                if (fragment.getAnimatingAway() == null && fragment.getAnimator() == null) {
                    ...
                    if (z4 || this.mNonConfig.shouldDestroy(fragment)) {
                        FragmentHostCallback fragmentHostCallback = this.mHost;
                    ...
                    if (fragment.mState == i6) {
                        Log.w("FragmentManager", "moveToState: Fragment state for " + fragment + " not updated inline; expected state " + i6 + " found " + fragment.mState);
                        fragment.mState = i6;
                        return;
                    }
                    return;
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (fragment == null) {
            fragment = getFragmentFactory().instantiate(context.getClassLoader(), attributeValue);
