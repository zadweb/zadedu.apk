        ...
        if (i6 <= 0 || i6 != i7) {
            ...
            while (constraintWidget14 != null) {
                ...
                if (constraintWidget15 != null || constraintWidget14 == constraintWidget3) {
                    ...
                    float margin22 = f6 + ((float) constraintWidget14.mListAnchors[i2].getMargin());
                    constraintWidget14.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin22);
                    float f152 = margin22 + f2;
                    constraintWidget14.mListAnchors[i8].getResolutionNode().resolve(resolutionNode.resolvedTarget, f152);
                    constraintWidget14.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem);
                    constraintWidget14.mListAnchors[i8].getResolutionNode().addResolvedValue(linearSystem);
                    f6 = f152 + ((float) constraintWidget14.mListAnchors[i8].getMargin());
                }
