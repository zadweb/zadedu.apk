...
public abstract class a {
    ...
    public void a(i iVar, com.b.a.a.a.b.d dVar) {
        ...
        for (h hVar : dVar.b()) {
            com.b.a.a.a.e.b.a(jSONObject4, hVar.a(), hVar.c());
        }
    ...
    public void a(String str, double d2) {
        if (d2 > this.e) {
            this.d = EnumC0008a.AD_STATE_VISIBLE;
            d.a().c(c(), str);
        }
    }
    ...
    public void b(String str, double d2) {
        if (d2 > this.e && this.d != EnumC0008a.AD_STATE_HIDDEN) {
            this.d = EnumC0008a.AD_STATE_HIDDEN;
            d.a().c(c(), str);
        }
    }
    ...
    public void i() {
        ...
        this.d = EnumC0008a.AD_STATE_IDLE;
    }
}
