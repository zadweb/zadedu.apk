...
public class fh {
    ...
    private static final String f1139a = fh.class.getSimpleName();
    private fb b;
    private fb c;
    private fs d;
    ...
    public synchronized void c() {
        if (d() && j()) {
            ...
            this.d.a(i2, new fu.b<JSONObject>() {
                /* class com.yandex.metrica.impl.ob.fh.AnonymousClass1 */

                public void a(JSONObject jSONObject) {
                    fh.this.a((fh) jSONObject);
                    fh.this.f = null;
                }
            }, new fu.a() {
                /* class com.yandex.metrica.impl.ob.fh.AnonymousClass2 */

                @Override // com.yandex.metrica.impl.ob.fu.a
                public void a(fr frVar) {
                    String str = fh.f1139a;
                    Log.i(str, "can't update pins on schedule: " + frVar.getMessage());
                    fh.this.h();
                    fh.this.f = null;
                }
            });
