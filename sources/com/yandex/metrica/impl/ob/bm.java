...
public final class bm {
    ...
    public static final class z {
        ...
        public static final String c = String.format(Locale.US, "(select count(%s.%s) from %s where %s.%s = %s.%s) = 0 and %s NOT IN (%s)", "reports", "id", "reports", "reports", "session_id", "sessions", "id", "id", com.yandex.metrica.impl.utils.e.a(2));
    }
    ...
    private static class t extends l {
        ...
        /* access modifiers changed from: protected */
        @Override // com.yandex.metrica.impl.ob.bm.l
