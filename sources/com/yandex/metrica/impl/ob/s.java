...
public class s {
    ...
    static class c extends e {
        ...
        @Override // com.yandex.metrica.impl.ob.s.e
        public boolean a() {
            return "DONE".equals(this.f1172a.c(null)) || "DONE".equals(this.f1172a.b(null));
        }

        /* access modifiers changed from: protected */
        @Override // com.yandex.metrica.impl.ob.s.e
        public void b() {
            if ("DONE".equals(this.f1172a.c(null))) {
                this.b.b();
            }
            String e = this.f1172a.e(null);
            if (!TextUtils.isEmpty(e)) {
                this.b.c(e);
            }
            if ("DONE".equals(this.f1172a.b(null))) {
                this.b.a();
            }
            this.f1172a.d();
            this.f1172a.e();
