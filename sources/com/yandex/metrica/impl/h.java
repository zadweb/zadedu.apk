...
public class h {
    ...
    public static h b(Bundle bundle) {
        ...
        return f2.c(z ? 1 : 0).d(bundle2.getInt("CounterReport.ConnectionType")).g(bundle2.getString("CounterReport.CellularConnectionType"));
    }
    ...
    public String toString() {
        return String.format(Locale.US, "[event: %s, type: %d, value: %s]", this.f1004a, Integer.valueOf(this.c), this.b);
    }
