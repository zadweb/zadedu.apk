...
public class MetricaService extends Service {
    ...
    private b f921a = new b() {
        /* class com.yandex.metrica.MetricaService.AnonymousClass1 */

        @Override // com.yandex.metrica.MetricaService.b
        public void a(int i) {
    ...
    private final IMetricaService.Stub c = new IMetricaService.Stub() {
        /* class com.yandex.metrica.MetricaService.AnonymousClass2 */
