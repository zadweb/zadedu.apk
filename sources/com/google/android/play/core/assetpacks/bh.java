...
public final class bh implements a {
    ...
    /* synthetic */ bh(l lVar) {
        ...
        cb cbVar = new cb();
        this.k = cbVar;
        this.l = cc.b(new cb(this.d, this.h, cbVar, this.e, (byte[]) null));
        ...
        this.v = b8;
        cb.b(this.k, cc.b(new bm(this.b, this.j, this.t, this.h, this.e, this.u, this.i, b8, null)));
        ce<cj> b9 = cc.b(new cu(this.g, this.k, this.e, this.b, this.c, this.i, null));
        this.w = b9;
