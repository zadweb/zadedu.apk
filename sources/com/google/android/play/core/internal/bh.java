...
public final class bh {
                ...
                try {
                    ...
                    if (read2 == -1) {
                        ...
                        switch (read2) {
                            ...
                            case MoPubView.MoPubAdSizeInt.HEIGHT_250_INT /*{ENCODED_INT: 250}*/:
                                read2 = dataInputStream.readUnsignedShort();
                                q(bArr, brVar, outputStream, (long) dataInputStream.readUnsignedShort(), read2, j3);
                                break;
                            case 251:
                                read2 = dataInputStream.readInt();
                                q(bArr, brVar, outputStream, (long) dataInputStream.readUnsignedShort(), read2, j3);
                            ...
                            case 253:
                                read2 = dataInputStream.readUnsignedShort();
                                q(bArr, brVar, outputStream, (long) dataInputStream.readInt(), read2, j3);
                                break;
                            case 254:
                                read2 = dataInputStream.readInt();
                                q(bArr, brVar, outputStream, (long) dataInputStream.readInt(), read2, j3);
    ...
    private static void q(byte[] bArr, br brVar, OutputStream outputStream, long j, int i, long j2) throws IOException {
        ...
        if (i2 < 0) {
            ...
            if (j3 <= j2) {
                try {
                    InputStream c = new bs(brVar, j, j3).c();
                    while (i2 > 0) {
                        try {
