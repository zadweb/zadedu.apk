...
public final class PlaybackInfo {
    ...
    public static PlaybackInfo createDummy(long j, TrackSelectorResult trackSelectorResult2) {
        return new PlaybackInfo(Timeline.EMPTY, DUMMY_MEDIA_PERIOD_ID, j, -9223372036854775807L, 1, null, false, TrackGroupArray.EMPTY, trackSelectorResult2, DUMMY_MEDIA_PERIOD_ID, j, 0, j);
    }
    ...
    public PlaybackInfo copyWithTrackInfo(TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult2) {
        return new PlaybackInfo(this.timeline, this.periodId, this.startPositionUs, this.contentPositionUs, this.playbackState, this.playbackError, this.isLoading, trackGroupArray, trackSelectorResult2, this.loadingMediaPeriodId, this.bufferedPositionUs, this.totalBufferedDurationUs, this.positionUs);
    }
