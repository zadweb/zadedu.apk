...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public void setPlayWhenReady(boolean z, int i) {
        ...
        if (z4 || z5 || z6) {
            notifyListeners(new BasePlayer.ListenerInvocation(z4, z, this.playbackInfo.playbackState, z5, i, z6, isPlaying2) {
                /* class com.google.android.exoplayer2.$$Lambda$ExoPlayerImpl$fmq0mZ64Jx_eCNhM7DubT3eF70 */
    ...
    public void seekTo(int i, long j) {
        ...
        notifyListeners($$Lambda$ExoPlayerImpl$Or0VmpLdRqfIa3jPOGIz08ZWLAg.INSTANCE);
    }
    ...
    private void handlePlaybackParameters(PlaybackParameters playbackParameters2, boolean z) {
        ...
        if (this.pendingSetPlaybackParametersAcks == 0 && !this.playbackParameters.equals(playbackParameters2)) {
            ...
            notifyListeners(new BasePlayer.ListenerInvocation() {
                /* class com.google.android.exoplayer2.$$Lambda$ExoPlayerImpl$jcYvCvfrCEOPmMf7WHLVKKZSViQ */
    ...
    private PlaybackInfo getResetPlaybackInfo(boolean z, boolean z2, boolean z3, int i) {
        ...
        return new PlaybackInfo(z2 ? Timeline.EMPTY : this.playbackInfo.timeline, dummyFirstMediaPeriodId, j2, j, i, z3 ? null : this.playbackInfo.playbackError, false, z2 ? TrackGroupArray.EMPTY : this.playbackInfo.trackGroups, z2 ? this.emptyTrackSelectorResult : this.playbackInfo.trackSelectorResult, dummyFirstMediaPeriodId, j2, 0, j2);
    }
    ...
    private void updatePlaybackInfo(PlaybackInfo playbackInfo2, boolean z, int i, int i2, boolean z2) {
        ...
        notifyListeners(new PlaybackInfoUpdate(playbackInfo2, playbackInfo3, this.listeners, this.trackSelector, z, i, i2, z2, this.playWhenReady, isPlaying != isPlaying()));
    }
    ...
    private void notifyListeners(BasePlayer.ListenerInvocation listenerInvocation) {
        notifyListeners(new Runnable(new CopyOnWriteArrayList(this.listeners), listenerInvocation) {
            /* class com.google.android.exoplayer2.$$Lambda$ExoPlayerImpl$DrcaME6RvvSdC72wmoYPUB4uP5w */
