...
public final class FlacReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) {
        ...
        if (this.streamMetadata == null) {
            ...
            setupData.format = Format.createAudioSampleFormat(null, "audio/flac", null, this.streamMetadata.bitRate(), i, this.streamMetadata.channels, this.streamMetadata.sampleRate, Collections.singletonList(copyOfRange), null, 0, null);
            return true;
