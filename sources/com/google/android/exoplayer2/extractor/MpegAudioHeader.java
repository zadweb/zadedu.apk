...
public final class MpegAudioHeader {
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        if (i3 == 3) {
            ...
            int i13 = i3 == 2 ? BITRATE_V1_L2[i4 - 1] : BITRATE_V1_L3[i4 - 1];
            i7 = ((i13 * 144) / i9) + i10;
            i8 = i13;
            i6 = 1152;
        } else {
            ...
            i7 = (((i3 == 1 ? 72 : 144) * i14) / i9) + i10;
            i8 = i14;
            i6 = i11;
        }
        mpegAudioHeader.setValues(i2, MIME_TYPE_BY_LAYER[3 - i3], i7, i9, ((i >> 6) & 3) == 3 ? 1 : 2, i8, i6);
        return true;
    }
