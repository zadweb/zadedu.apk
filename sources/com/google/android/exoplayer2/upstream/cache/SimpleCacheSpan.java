...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j, long j2, CachedContentIndex cachedContentIndex) {
        ...
        return new SimpleCacheSpan(keyForId, Long.parseLong(matcher.group(2)), length, j2 == -9223372036854775807L ? Long.parseLong(matcher.group(3)) : j2, file2);
    }
    ...
    private static File upgradeFile(File file, CachedContentIndex cachedContentIndex) {
        ...
        File cacheFile = getCacheFile((File) Assertions.checkStateNotNull(file.getParentFile()), cachedContentIndex.assignIdForKey(str), Long.parseLong(matcher.group(2)), Long.parseLong(matcher.group(3)));
