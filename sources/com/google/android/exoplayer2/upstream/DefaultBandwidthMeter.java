...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder(Context context2) {
            ...
            this.slidingWindowMaxWeight = AdError.SERVER_ERROR_CODE;
    ...
    public DefaultBandwidthMeter() {
        this(null, new SparseArray(), AdError.SERVER_ERROR_CODE, Clock.DEFAULT, false);
    }
    ...
    private synchronized void onConnectivityAction() {
        ...
        if (this.networkType != networkType2) {
            ...
            if (networkType2 != 1 && networkType2 != 0 && networkType2 != 8) {
