...
public final class DefaultAudioSink implements AudioSink {
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.inputBuffer == null) {
            ...
            if (this.afterDrainPlaybackParameters != null) {
                ...
                applyPlaybackParameters(playbackParameters2, j);
            }
    ...
    private void applyPlaybackParameters(PlaybackParameters playbackParameters2, long j) {
        this.playbackParametersCheckpoints.add(new PlaybackParametersCheckpoint(this.configuration.canApplyPlaybackParameters ? this.audioProcessorChain.applyPlaybackParameters(playbackParameters2) : PlaybackParameters.DEFAULT, Math.max(0L, j), this.configuration.framesToDurationUs(getWrittenFrames())));
