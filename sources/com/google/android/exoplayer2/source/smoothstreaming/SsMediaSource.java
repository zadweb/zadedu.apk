...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    private void processManifest() {
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(-9223372036854775807L, j3, j2, msToUs, true, true, true, this.manifest, this.tag);
        } else {
            long j4 = this.manifest.durationUs != -9223372036854775807L ? this.manifest.durationUs : j - j2;
            singlePeriodTimeline = new SinglePeriodTimeline(j2 + j4, j4, j2, 0, true, false, false, this.manifest, this.tag);
        }
        ...
        if (this.manifest.isLive) {
            this.manifestRefreshHandler.postDelayed(new Runnable() {
                ...
                public final void run() {
                    SsMediaSource.lambda$tFjHmMdOxDkhvkY7QhPdfdPmbtI(SsMediaSource.this);
                }
