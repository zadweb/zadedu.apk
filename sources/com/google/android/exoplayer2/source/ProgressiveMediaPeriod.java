...
public final class ProgressiveMediaPeriod implements ExtractorOutput, MediaPeriod, SampleQueue.UpstreamFormatChangedListener, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback {
    ...
    public ProgressiveMediaPeriod(Uri uri2, DataSource dataSource2, Extractor[] extractorArr, DrmSessionManager<?> drmSessionManager2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, MediaSourceEventListener.EventDispatcher eventDispatcher2, Listener listener2, Allocator allocator2, String str, int i) {
        ...
        this.maybeFinishPrepareRunnable = new Runnable() {
            ...
            public final void run() {
                ProgressiveMediaPeriod.lambda$XtIxRPmKXOyt2tIiDgXldkLBDgg(ProgressiveMediaPeriod.this);
            }
        };
    ...
    public final class ExtractingLoadable implements IcyDataSource.Listener, Loader.Loadable {
        ...
        private DataSpec buildDataSpec(long j) {
            return new DataSpec(this.uri, j, -1, ProgressiveMediaPeriod.this.customCacheKey, 6, ProgressiveMediaPeriod.ICY_METADATA_HEADERS);
        }
