    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            if (zza4.zzc == 0 || ((zza4.zzc == -1 && zza4.zza == 0) || (zza4.zzc == 1 && zza4.zzb == 0))) {
                ...
                if (zza4.zzc == 1) {
                    try {
                        DynamiteModule zza5 = zza(context, str, zza4.zzb);
                        if (zza3.zza != null) {
                            zza3.zza.close();
                        }
                        zzf.set(zza2);
                        ...
                        DynamiteModule zza6 = zza(context, str);
                        if (zza3.zza != null) {
                            zza3.zza.close();
                        }
                        zzf.set(zza2);
                                    ...
                                    if (zzd != null) {
                                        if (!zzd.isEmpty()) {
                                            if (Build.VERSION.SDK_INT >= 29) {
                                                classLoader = new DelegateLastClassLoader(zzd, ClassLoader.getSystemClassLoader());
                                            } else {
                                                classLoader = new zzi(zzd, ClassLoader.getSystemClassLoader());
                                            }
                                            zza(classLoader);
