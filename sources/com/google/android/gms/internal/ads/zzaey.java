...
public final class zzaey extends AbstractSafeParcelable {
    ...
    public zzaey(Bundle bundle, zzang zzang, ApplicationInfo applicationInfo2, String str, List<String> list, @Nullable PackageInfo packageInfo, String str2, boolean z, String str3) {
        this.zzcfy = bundle;
        this.zzcfz = zzang;
