...
public interface zzbdl {
    ...
    <T> T zza(zzbdm<T> zzbdm, zzbbb zzbbb) throws IOException;

    <T> void zza(List<T> list, zzbdm<T> zzbdm, zzbbb zzbbb) throws IOException;

    <K, V> void zza(Map<K, V> map, zzbcn<K, V> zzbcn, zzbbb zzbbb) throws IOException;
    ...
    @Deprecated
    <T> T zzb(zzbdm<T> zzbdm, zzbbb zzbbb) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzbdm<T> zzbdm, zzbbb zzbbb) throws IOException;
