...
public final class zzaco implements zzacd<zzoq> {
    ...
    public final /* synthetic */ zzoq zza(zzabv zzabv, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        String str;
        List<zzanz<zzon>> zza = zzabv.zza(jSONObject, "images", false, this.zzcbk, this.zzcbl);
        zzanz<zzon> zza2 = zzabv.zza(jSONObject, "secondary_image", false, this.zzcbk);
        ...
        if (this.zzbto) {
            if (((Boolean) zzkb.zzik().zzd(zznk.zzbfr)).booleanValue()) {
                ...
                return new zzoq(str, arrayList, jSONObject.getString("body"), (zzpw) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.getString("advertiser"), (zzoj) zzg.get(), new Bundle(), zzc2 == null ? zzc2.zztm() : null, zzc2 == null ? zzc2.getView() : null, null, null);
            }
        }
        str = string;
        return new zzoq(str, arrayList, jSONObject.getString("body"), (zzpw) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.getString("advertiser"), (zzoj) zzg.get(), new Bundle(), zzc2 == null ? zzc2.zztm() : null, zzc2 == null ? zzc2.getView() : null, null, null);
