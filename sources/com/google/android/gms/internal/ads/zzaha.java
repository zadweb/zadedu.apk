        ...
        if (i == 1) {
            ...
            if (i == 3) {
                ...
                if (readStrongBinder != null) {
                    ...
                    zzahe = queryLocalInterface instanceof zzahe ? (zzahe) queryLocalInterface : new zzahg(readStrongBinder);
                }
                zza(zzahe);
            } else if (i != 34) {
                switch (i) {
                    ...
                    case 16:
                        ...
                        if (readStrongBinder2 != null) {
                            ...
                            zzagx = queryLocalInterface2 instanceof zzagx ? (zzagx) queryLocalInterface2 : new zzagy(readStrongBinder2);
                        }
                        zza(zzagx);
                        break;
                    default:
