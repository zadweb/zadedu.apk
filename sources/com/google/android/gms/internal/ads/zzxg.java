    ...
    public static void zza(Context context, String str, zzajh zzajh, String str2, boolean z, List<String> list) {
        if (!(list == null || list.isEmpty())) {
            ...
            for (String str4 : list) {
                String zza = zza(zza(zza(zza(zza(zza(zza(str4, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzajh.zzcod.zzbst), "@gw_sdkver@", str), "@gw_sessid@", zzkb.zzih()), "@gw_seqnum@", zzajh.zzccy), "@gw_adnetstatus@", zzajh.zzcoe);
                if (zzajh.zzbtw != null) {
                    zza = zza(zza(zza, "@gw_adnetid@", zzajh.zzbtw.zzbrs), "@gw_allocid@", zzajh.zzbtw.zzbru);
                }
    ...
    public static void zza(Context context, String str, List<String> list, String str2, zzaig zzaig) {
        if (!(list == null || list.isEmpty())) {
            ...
            for (String str3 : list) {
                ...
                if (zzaig != null) {
                    zza = zza(zza(zza, "@gw_rwd_itm@", Uri.encode(zzaig.type)), "@gw_rwd_amt@", Integer.toString(zzaig.zzcmk));
                }
                zzbv.zzek();
