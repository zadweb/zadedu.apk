...
public final class zzju extends zzjr.zza<zzks> {
    ...
    public final /* synthetic */ zzks zza(zzld zzld) throws RemoteException {
        return zzld.createInterstitialAdManager(ObjectWrapper.wrap(this.val$context), this.zzarq, this.zzarr, this.zzars, GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_VERSION_CODE);
    }
