...
public final class zzagb {
    ...
    public zzagb(Context context) {
        ...
        this.zzcjm = zza(packageManager, "http://www.google.com") == null ? false : z;
    ...
    private final void zzp(Context context) {
        ...
        if (registerReceiver != null) {
            ...
            this.zzckc = (double) (((float) registerReceiver.getIntExtra("level", -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
