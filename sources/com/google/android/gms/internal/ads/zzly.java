    ...
    public final void zza(zzlw zzlw) {
        try {
            if (this.zzasy == null) {
                ...
                zzks zzks = (zzks) ("search_v2".equals(zza.zzarb) ? zzjr.zza(context, false, (zzjr.zza) new zzjt(zzkb.zzig(), context, zza, this.zzye)) : zzjr.zza(context, false, (zzjr.zza) new zzjs(zzkb.zzig(), context, zza, this.zzye, this.zzast)));
                this.zzasy = zzks;
                zzks.zza(new zzjf(this.zzasw));
                if (this.zzapt != null) {
