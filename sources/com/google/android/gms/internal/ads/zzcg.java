...
public class zzcg extends zzcf {
    ...
    public final long zza(StackTraceElement[] stackTraceElementArr) throws zzcw {
    ...
    /* access modifiers changed from: protected */
    @Override // com.google.android.gms.internal.ads.zzcf
    public final zzba zza(Context context, View view, Activity activity) {
        List list;
        Long l;
        zzba zzba = new zzba();
        ...
        if (!zzb.isInitialized()) {
            zzba.zzdu = 16384L;
            list = Arrays.asList(new zzdt(zzb, zzba));
        } else {
            try {
            ...
            if (this.zzqa > 0 && zzdg.zza(this.zzqq)) {
                ...
                if (this.zzqp && this.zzpy != null) {
                    ...
                    long zza3 = zzdg.zza((double) (((this.zzql - this.zzqn) + this.zzpy.getRawY()) - this.zzpy.getY()), this.zzqq);
                    if (zza3 != 0) {
                        zzbb.zzgd = Long.valueOf(zza3);
                    }
                }
            }
            try {
                ...
                if (this.zzqp) {
                    ...
                    if (this.zzqb > 0) {
                        if (zzdg.zza(this.zzqq)) {
                            double d = (double) this.zzqg;
                            double d2 = (double) this.zzqb;
                            Double.isNaN(d);
                            Double.isNaN(d2);
                        ...
                        zzbb.zzfq = l;
                        double d3 = (double) this.zzqf;
                        double d4 = (double) this.zzqb;
                        Double.isNaN(d3);
                        Double.isNaN(d4);
                        zzbb.zzfs = Long.valueOf(Math.round(d3 / d4));
                    }
                    zzbb.zzfw = zzb2.zzfw;
                    zzbb.zzfv = zzb2.zzfv;
            ...
            try {
                ...
                if (size > 0) {
                    ...
                    for (int i = 0; i < size; i++) {
                        zzdf zza4 = zza(zzps, (MotionEvent) this.zzpz.get(i), this.zzqq);
                        zzbb zzbb2 = new zzbb();
                        zzbb2.zzdo = zza4.zzsp;
                        zzbb2.zzdp = zza4.zzsq;
                        zzba.zzeu[i] = zzbb2;
                    }
                }
            } catch (zzcw unused3) {
    ...
    /* access modifiers changed from: protected */
    @Override // com.google.android.gms.internal.ads.zzcf
    public final zzba zza(Context context, zzax zzax) {
        zzba zzba = new zzba();
        if (!TextUtils.isEmpty(this.zzqu)) {
            zzba.zzcw = this.zzqu;
        }
        zzcz zzb = zzb(context, this.zzqt);
        if (zzb.zzab() != null) {
            zza(zza(zzb, zzba, (zzax) null));
        }
        return zzba;
    }

    /* access modifiers changed from: protected */
    public List<Callable<Void>> zza(zzcz zzcz, zzba zzba, zzax zzax) {
        int zzx = zzcz.zzx();
        ArrayList arrayList = new ArrayList();
        ...
        arrayList.add(new zzdo(zzcz, "LJD7GILw6ox/o3kYqhR5FF4FDylErrAaJ66Y8V8gtnNGF8DcetGJrYvTlHeK8kyR", "GKdCM/OywOIR4FMFS5XrDdTIpVvhoMFma/KSfRUdsbQ=", zzba, zzx, 27, zzax));
        arrayList.add(new zzdr(zzcz, "1GzFbNgtZBsZ6xBrCbOvmw4GuyabWdtXgJqf+Aoik3E00oSTfDga4UiXvbD1YLYB", "1EiWqNFog84woyMiTveFonfDO5rsRz44QrKedC4xw+8=", zzba, startTime, zzx, 25));
        arrayList.add(new zzdw(zzcz, "uFEr0moMuWuurgrUpfSBjyUksFv6IqKMSuNqo2jCjRmu9JHDaSBf9LDKs2u/XE/B", "hDtufeJTxJSs5qQMCIPuyzc9ZPOtO/34yyf8Kf44rGo=", zzba, zzx, 1));
        arrayList.add(new zzdy(zzcz, "+8WN7RfVBrTKK5NXM+y9JA4Ygu2jPZokHNFGgulhBRZ32uCnyKWWGQNTE1weoQCM", "peILYfFejTn8xmazfpiZWeK2eaYjjxEBmAZ8bUD9PWU=", zzba, zzx, 31));
        arrayList.add(new zzed(zzcz, "R1L5/7J00Fko/kDi6VDsBhCzpp4/7wzabnzdihUS7rPLvaXLFWrERChyvYYgVJRF", "4WtEOgM4wQ7wiw1OB3pMyAbaplBizcjE6LRBT/nrDgM=", zzba, zzx, 33));
        arrayList.add(new zzdn(zzcz, "1DzTSPdcTVkbB0cTQEaPo/MU1E1TGypt38nYJILt/8CcQbOuYjF6hLShUHnLb5uw", "dkCo8xze5sFyp7Msrb8F1JKjVIP7LutspgZPYQvsMlo=", zzba, zzx, 29));
        arrayList.add(new zzdp(zzcz, "6hrke/fCJ5tLCck7L6DvYxDB/To2PLUVGD3lbM1fdL2y9IScTypVRvrPFLLn4rDM", "+GAY853+DQRMYkeMG8Hbv1THvRgwf43Jh+3p4yQDqGw=", zzba, zzx, 5));
        arrayList.add(new zzdv(zzcz, "f8J+j+UhiTEjRF3iyDcFnM9Rm6LC/P+2PE2qff5S0gHSDPzrH4HNcnCaI+twvhbv", "MOBosqV6pejtL/WEgsHP3Y2p2WtApcEEa2XyqqRQCo0=", zzba, zzx, 12));
        arrayList.add(new zzdx(zzcz, "bYi99wWoqjOnUF4nnSWQsu9qLqARRsoauNez1uhJPws2YAlolLPh/xgKDnyI06MJ", "pjeIE8EsMfMk4SIebXHXNWKXTpK8v5vG6YqOxp1QH1M=", zzba, zzx, 3));
        arrayList.add(new zzdq(zzcz, "C4t4eP72HKoZsX62gBXGicLgvQbyKikYhXkvESjpMVAOEyUibmrLmpkJ5lZygzZE", "onbJNRechKgg7ilJYzLDEQ07M0uNlDZp05nZ4h6WJ40=", zzba, zzx, 44));
        arrayList.add(new zzdu(zzcz, "YOE4tLd8IhAbsNGoUEFHfu51/79yG0YlK4bMxi/e6gOIrtpqPN+TQgqpfYNBoiRy", "aFY444Zz3/sMYl+Q7uujofvlLWJ37651UMbaKJCFBnU=", zzba, zzx, 22));
        arrayList.add(new zzee(zzcz, "ug+duzFNTlMWhYez8qKOR3bxkM8vLOPy9xVUBCCMTrplDFf/BnF2bNmA7hw0iYtI", "ogMtakENM6NAXJL7DCVTIbgawd5T3ZVhEaXugMAz+D4=", zzba, zzx, 48));
        arrayList.add(new zzdm(zzcz, "PRnAd1qZLf3/u2x/ZslcDq2vQzDbmFHkH/jSij536nFGwYo+g6o8PpQOJcDeuz++", "99eM4BYfXxOCBAhS2wQJENWQ4BMWrR/wKqrfHx1Ws8w=", zzba, zzx, 49));
        arrayList.add(new zzeb(zzcz, "Q7gHsedaZvBKvqRLQGMIPKihViSMmXus6bBgU0lNdv+Pm9sSlP+Z+JltWG56lF1K", "mrdNgIRzsAu+cEIamFRkeCivuYIijUjvD76p38JyQec=", zzba, zzx, 51));
        arrayList.add(new zzdz(zzcz, "WiMYovSpRj6RF1r6zXON0hYVyLxgllUAYyMyyeBevdbJbdYcoBpd8nDjCwwclcSu", "vpq7z91A+vN3MIS65A+GwiFRgEFOFpQOdK5Z+mjW21w=", zzba, zzx, 61));
        return arrayList;
    }

    /* access modifiers changed from: protected */
    @Override // com.google.android.gms.internal.ads.zzcf
    public final zzdf zzb(MotionEvent motionEvent) throws zzcw {
