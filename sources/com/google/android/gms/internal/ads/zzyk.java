...
public final class zzyk extends zzxr {
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjj zzjj, String str, zzaic zzaic, String str2) throws RemoteException {
        ...
        try {
            ...
            Bundle zza = zza(str2, zzjj, (String) null);
            if (zzjj != null) {
                zzyj zzyj2 = new zzyj(zzjj.zzapw == -1 ? null : new Date(zzjj.zzapw), zzjj.zzapx, zzjj.zzapy != null ? new HashSet(zzjj.zzapy) : null, zzjj.zzaqe, zzm(zzjj), zzjj.zzaqa, zzjj.zzaql);
                bundle = zzjj.zzaqg != null ? zzjj.zzaqg.getBundle(mediationRewardedVideoAdAdapter.getClass().getName()) : null;
                zzyj = zzyj2;
            } else {
                zzyj = null;
                bundle = null;
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjj zzjj, String str, String str2, zzxt zzxt) throws RemoteException {
        ...
        try {
            ...
            if (zzjj.zzaqg != null) {
                bundle = zzjj.zzaqg.getBundle(mediationInterstitialAdapter.getClass().getName());
            }
            mediationInterstitialAdapter.requestInterstitialAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzyl(zzxt), zza(str, zzjj, str2), zzyj, bundle);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjj zzjj, String str, String str2, zzxt zzxt, zzpl zzpl, List<String> list) throws RemoteException {
        ...
        try {
            ...
            if (zzjj.zzaqg != null) {
                bundle = zzjj.zzaqg.getBundle(mediationNativeAdapter.getClass().getName());
            }
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjn zzjn, zzjj zzjj, String str, String str2, zzxt zzxt) throws RemoteException {
        ...
        try {
            ...
            zzyj zzyj = new zzyj(zzjj.zzapw == -1 ? null : new Date(zzjj.zzapw), zzjj.zzapx, zzjj.zzapy != null ? new HashSet(zzjj.zzapy) : null, zzjj.zzaqe, zzm(zzjj), zzjj.zzaqa, zzjj.zzaql);
            if (zzjj.zzaqg != null) {
                bundle = zzjj.zzaqg.getBundle(mediationBannerAdapter.getClass().getName());
            }
            mediationBannerAdapter.requestBannerAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzyl(zzxt), zza(str, zzjj, str2), zzb.zza(zzjn.width, zzjn.height, zzjn.zzarb), zzyj, bundle);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
