...
public final /* synthetic */ class zzbbh {
    static final /* synthetic */ int[] zzdql;
    ...
    static {
        int[] iArr = new int[zzbes.values().length];
        zzdql = iArr;
        try {
            iArr[zzbes.DOUBLE.ordinal()] = 1;
        ...
        int[] iArr2 = new int[zzbex.values().length];
        zzdrb = iArr2;
        iArr2[zzbex.INT.ordinal()] = 1;
