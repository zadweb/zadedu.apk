...
public final class zziu extends zzbfc<zziu> {
    ...
    public final int zzr() {
        ...
        zziy zziy = this.zzaox;
        if (zziy != null) {
            zzr += zzbfa.zzb(5, zziy);
        }
        zzja zzja = this.zzaoy;
        if (zzja != null) {
            zzr += zzbfa.zzb(6, zzja);
        }
        zzjb zzjb = this.zzaoz;
        if (zzjb != null) {
            zzr += zzbfa.zzb(7, zzjb);
        }
        zzjc zzjc = this.zzapa;
        if (zzjc != null) {
            zzr += zzbfa.zzb(8, zzjc);
        }
        zziv zziv = this.zzapb;
        if (zziv != null) {
            zzr += zzbfa.zzb(9, zziv);
        }
        zziz zziz = this.zzapc;
        if (zziz != null) {
            zzr += zzbfa.zzb(10, zziz);
        }
        zzix zzix = this.zzapd;
        if (zzix != null) {
            zzr += zzbfa.zzb(11, zzix);
        }
        Integer num = this.zzape;
        if (num != null) {
