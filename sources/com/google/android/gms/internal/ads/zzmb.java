...
public final class zzmb {
    ...
    public final RewardedVideoAd getRewardedVideoAdInstance(Context context) {
        synchronized (sLock) {
            ...
            zzahm zzahm = new zzahm(context, (zzagz) zzjr.zza(context, false, (zzjr.zza) new zzjz(zzkb.zzig(), context, new zzxm())));
            this.zzatg = zzahm;
            return zzahm;
        }
    }
    ...
    public final void zza(Context context, String str, zzmd zzmd) {
        synchronized (sLock) {
            if (this.zzatf == null) {
                if (context != null) {
                    try {
                        zzlj zzlj = (zzlj) zzjr.zza(context, false, (zzjr.zza) new zzjw(zzkb.zzig(), context));
                        this.zzatf = zzlj;
                        zzlj.zza();
                        if (str != null) {
