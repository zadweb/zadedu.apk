...
public final class zzaqc implements zzv<zzapw> {
    ...
    public final /* synthetic */ void zza(zzapw zzapw, Map map) {
        ...
        if ("background".equals(str)) {
            ...
            try {
                zzapw2.setBackgroundColor(Color.parseColor(str2));
            ...
            if ("decoderProps".equals(str)) {
                ...
                if (str3 == null) {
                    ...
                    zzapi.zza(zzapw2, hashMap);
                }
            } else {
                zzapn zztl = zzapw2.zztl();
                if (zztl == null) {
                ...
                if (equals || equals2) {
                    ...
                    if (((Boolean) zzkb.zzik().zzd(zznk.zzbca)).booleanValue()) {
                        zza3 = Math.min(zza3, zzapw2.zzts() - zza);
                        i = Math.min(zza4, zzapw2.zztr() - zza2);
                    } else {
                        i = zza4;
                    }
                    try {
                ...
                if (zzth2 == null) {
                    ...
                    Context context2 = zzapw2.getContext();
                    ...
                    Context context3 = zzapw2.getContext();
