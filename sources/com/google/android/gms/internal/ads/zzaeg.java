...
public final class zzaeg {
    ...
    public zzaeg(Bundle bundle, zzjj zzjj, zzjn zzjn, String str, ApplicationInfo applicationInfo2, PackageInfo packageInfo, String str2, String str3, zzang zzang, Bundle bundle2, List<String> list, List<String> list2, Bundle bundle3, boolean z, int i, int i2, float f, String str4, long j, String str5, List<String> list3, String str6, zzpl zzpl, String str7, float f2, boolean z2, int i3, int i4, boolean z3, boolean z4, Future<String> future, String str8, boolean z5, int i5, Bundle bundle4, String str9, zzlu zzlu, boolean z6, Bundle bundle5, boolean z7, Future<String> future2, List<Integer> list4, String str10, List<String> list5, int i6, boolean z8, boolean z9, boolean z10, ArrayList<String> arrayList) {
        List<String> list6;
        this.zzccu = bundle;
        this.zzccv = zzjj;
        this.zzacv = zzjn;
