...
public interface zzbey {
    ...
    void zza(int i, zzbah zzbah) throws IOException;

    <K, V> void zza(int i, zzbcn<K, V> zzbcn, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzbdm zzbdm) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzbdm zzbdm) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzbdm zzbdm) throws IOException;

    void zzb(int i, List<zzbah> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzbdm zzbdm) throws IOException;
