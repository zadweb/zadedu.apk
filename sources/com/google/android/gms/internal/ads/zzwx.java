...
public final class zzwx {
    ...
    public zzwx(JSONObject jSONObject) throws JSONException {
        ...
        zzbv.zzfd();
        this.zzbsd = !((Boolean) zzkb.zzik().zzd(zznk.zzaxv)).booleanValue() ? this.zzbse : zzxg.zza(jSONObject, "video_reward_urls");
        ...
        JSONObject optJSONObject2 = jSONObject.optJSONObject(c.DATA);
