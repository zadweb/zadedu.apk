...
public class zzbdp<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.android.gms.internal.ads.zzbdp<K extends java.lang.Comparable<K>, V> */
    ...
    public final V put(K k, V v) {
        ...
        if (size == i2) {
            ...
            zzafw().put((K) ((Comparable) remove.getKey()), (V) remove.getValue());
        }
