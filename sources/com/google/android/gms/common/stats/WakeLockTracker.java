...
public class WakeLockTracker {
    ...
    public void registerEvent(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        if (zza()) {
            if (TextUtils.isEmpty(str)) {
                ...
                zza(context, new WakeLockEvent(System.currentTimeMillis(), i, str2, i2, StatsUtils.zza(list), str, SystemClock.elapsedRealtime(), zza.zza(context), str3, StatsUtils.zza(context.getPackageName()), zza.zzb(context), j, str4, false));
            }
        }
    }
    ...
    public void registerDeadlineEvent(Context context, String str, String str2, String str3, int i, List<String> list, boolean z, long j) {
        if (zza()) {
            zza(context, new WakeLockEvent(System.currentTimeMillis(), 16, str, i, StatsUtils.zza(list), null, j, zza.zza(context), str2, StatsUtils.zza(context.getPackageName()), zza.zzb(context), 0, str3, z));
        }
    }
