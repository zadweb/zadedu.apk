    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zak.keySet()) {
                ...
                zaq zaq2 = new zaq(api2, z2);
                arrayList.add(zaq2);
                Api.AbstractClientBuilder abstractClientBuilder = (Api.AbstractClientBuilder) Preconditions.checkNotNull(api2.zab());
                Api.Client buildClient = abstractClientBuilder.buildClient(this.zaj, this.zao, buildClientSettings, (Object) apiOptions, (ConnectionCallbacks) zaq2, (OnConnectionFailedListener) zaq2);
