...
public final class k {
    public static void a(final Context context, final ImageView imageView) {
        new Thread(new Runnable() {
            /* class com.appnext.core.k.AnonymousClass1 */

            public final void run() {
                try {
                    final Bitmap Y = f.Y("https://cdn.appnext.com/tools/sdk/adchoices/adchoices_big.png");
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.core.k.AnonymousClass1.AnonymousClass1 */
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.core.k.AnonymousClass1.AnonymousClass2 */
