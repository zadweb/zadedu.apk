...
public class ResultPageActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.ic = this.f1if.getSelectedAd();
            this.fJ = this.f1if.A();
            this.ca = this.f1if.B();
            this.userAction = new q(this, new q.a() {
                /* class com.appnext.core.result.ResultPageActivity.AnonymousClass1 */
                ...
                @Override // com.appnext.core.q.a
                public final Ad e() {
                    return ResultPageActivity.this.f1if.D();
                }
                ...
                @Override // com.appnext.core.q.a
                public final p g() {
                    return ResultPageActivity.this.f1if.C();
                }
            });
            this.ie = this.f1if.E();
            ...
            this.webView.setWebChromeClient(new WebChromeClient() {
                /* class com.appnext.core.result.ResultPageActivity.AnonymousClass2 */
            ...
            AppnextWebView.u(this).a(str, new AppnextWebView.c() {
                /* class com.appnext.core.result.ResultPageActivity.AnonymousClass3 */

                @Override // com.appnext.core.webview.AppnextWebView.c
                public final void f(String str) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.core.result.ResultPageActivity.AnonymousClass3.AnonymousClass1 */
                ...
                public final void error(String str) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.core.result.ResultPageActivity.AnonymousClass3.AnonymousClass2 */
    ...
    public class b {
        ...
        public final void adClicked(String str, int i) {
            ...
            sb.append(resultPageActivity2.h((ResultPageActivity) resultPageActivity2.aE).getAppURL());
            sb.append("&tem_id=");
            sb.append(ResultPageActivity.this.id);
            sb.append("1");
            qVar.a(appnextAd, sb.toString(), ResultPageActivity.this.placementID, new e.a() {
                /* class com.appnext.core.result.ResultPageActivity.b.AnonymousClass1 */
        ...
        public final void postView(String str) {
            ...
            q qVar = ResultPageActivity.this.userAction;
            qVar.a(appnextAd, ResultPageActivity.this.h((ResultPageActivity) appnextAd).getImpressionURL() + "&tem_id=" + ResultPageActivity.this.id + "1", null);
        }
    ...
    public class a extends WebViewClient {
        ...
        public final void onPageFinished(WebView webView, String str) {
            ...
            new Thread(new Runnable() {
                /* class com.appnext.core.result.ResultPageActivity.a.AnonymousClass1 */

                public final void run() {
                    final String b = f.b((Context) ResultPageActivity.this, false);
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.core.result.ResultPageActivity.a.AnonymousClass1.AnonymousClass1 */

                        public final void run() {
                            try {
                                ResultPageActivity resultPageActivity = ResultPageActivity.this;
                                resultPageActivity.loadJS("Appnext.setParams(" + d.br().bs().getConfigParams().put("did", b).toString() + ");");
                            } catch (Throwable unused) {
                            }
                            ResultPageActivity resultPageActivity2 = ResultPageActivity.this;
                            resultPageActivity2.loadJS("Appnext.load(" + ResultPageActivity.this.h((ResultPageActivity) ResultPageActivity.this.ic).getAdJSON() + "," + ResultPageActivity.this.ca + "," + ResultPageActivity.this.fJ + ");");
                        }
                    });
                }
            }).start();
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Can't wrap try/catch for region: R(7:0|1|2|(1:4)|5|6|8) */
