...
public class g extends a {
    ...
    public void inflateView(int i, AppnextAd appnextAd) {
        try {
            ...
            this.webView.setWebChromeClient(new WebChromeClient() {
                /* class com.appnext.banners.g.AnonymousClass1 */
            ...
            AppnextWebView.u(this.context).a(jSurl, new AppnextWebView.c() {
                /* class com.appnext.banners.g.AnonymousClass2 */

                @Override // com.appnext.core.webview.AppnextWebView.c
                public final void f(String str) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.banners.g.AnonymousClass2.AnonymousClass1 */
                ...
                public final void error(String str) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class com.appnext.banners.g.AnonymousClass2.AnonymousClass2 */
    ...
    public void destroy() {
        super.destroy();
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            /* class com.appnext.banners.g.AnonymousClass3 */
    ...
    public class a {
        ...
        public void openStore(String str) {
            ...
            if (!g.this.isDestroyed()) {
                g.this.handler.post(new Runnable() {
                    /* class com.appnext.banners.g.a.AnonymousClass1 */
        ...
        public void logSTP(String str, String str2) {
            f.a(g.this.getBannerAd(), g.this.getSelectedAd(), str, str2, d.S());
        }
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void openResultPage(boolean z) {
    ...
    private void pageFinished() {
        if (!isDestroyed()) {
            new Thread(new Runnable() {
                /* class com.appnext.banners.g.AnonymousClass4 */

                public final void run() {
                    g gVar = g.this;
                    gVar.adsid = f.b(gVar.context, false);
                    g.this.handler.removeCallbacksAndMessages(null);
                    g.this.handler.post(new Runnable() {
                        /* class com.appnext.banners.g.AnonymousClass4.AnonymousClass1 */
    ...
    private void activateAutoRefresh() {
        ...
        if (Boolean.parseBoolean(S.get("_arFlag")) && i > 0) {
            this.refreshHandler.postDelayed(new Runnable() {
                /* class com.appnext.banners.g.AnonymousClass5 */

                public final void run() {
                    try {
                        AppnextAd a2 = b.R().a(g.this.context, g.this.getBannerAd(), g.this.getAds(), g.this.getAdRequest().getCreativeType(), g.this.shown);
                        if (a2 != null) {
                            ...
                            if (Boolean.parseBoolean(d.S().get("impOne"))) {
                                ...
                                g.this.refreshHandler.postDelayed(new Runnable() {
                                    /* class com.appnext.banners.g.AnonymousClass5.AnonymousClass1 */
