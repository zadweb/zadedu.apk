...
public class b {
    ...
    private static a a(String str, c cVar, Bundle bundle, Object obj) {
        ...
        try {
            Object newInstance = Class.forName(B(str)).getConstructor(c.class, Bundle.class, Object.class).newInstance(cVar, bundle, obj);
    ...
    public final void a(String str, c cVar, Bundle bundle, Object obj, a.AbstractC0006a aVar) {
        if (cVar != null) {
            try {
