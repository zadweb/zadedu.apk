    ...
    public int onRunJob(final JobParameters jobParameters) {
        ...
        try {
            ...
            if (extras == null) {
                ...
                cVar = new c(extras.getString("status", ""), extras.getString(com.appnext.base.b.c.eQ, ""), extras.getString(com.appnext.base.b.c.eR, ""), extras.getString(com.appnext.base.b.c.eO, ""), extras.getString(com.appnext.base.b.c.eP, ""), extras.getString("key", ""), extras.getString("service_key", ""), extras.getString(com.appnext.base.b.c.DATA, null));
            }
            if (cVar == null) {
                b(jobParameters);
                return 0;
                ...
                try {
                    new b().a(getApplicationContext(), cVar.getKey(), null, bundle, null, new a.AbstractC0006a() {
                        /* class com.appnext.base.services.OperationJobService.AnonymousClass1 */

                        @Override // com.appnext.base.operations.a.AbstractC0006a
