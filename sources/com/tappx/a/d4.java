...
public class d4 {
    ...
    public class g implements Runnable {
        ...
        public void run() {
            ...
            int[] iArr = new int[2];
            ViewGroup l = d4.this.l();
            l.getLocationOnScreen(iArr);
            d4.this.h.c(iArr[0], iArr[1], l.getWidth(), l.getHeight());
    ...
    public static class j {
        ...
        public static class a {
            ...
            class RunnableC0031a implements Runnable {
                ...
                class ViewTreeObserver$OnPreDrawListenerC0032a implements ViewTreeObserver.OnPreDrawListener {

                    /* renamed from: a  reason: collision with root package name */
                    final /* synthetic */ View f657a;

                    ViewTreeObserver$OnPreDrawListenerC0032a(View view) {
                        this.f657a = view;
                    }
                ...
                public void run() {
                    View[] viewArr = a.this.f655a;
                    for (View view : viewArr) {
                        if (view.getHeight() > 0 || view.getWidth() > 0) {
                            a.this.b();
                        } else {
                            view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver$OnPreDrawListenerC0032a(view));
                        }
                    }
                }
            }
        ...
        public a a(View... viewArr) {
            a aVar = new a(this.f654a, viewArr, null);
            this.b = aVar;
            return aVar;
        }
    ...
    d4(Context context, b4 b4Var, c4 c4Var, c4 c4Var2, j jVar) {
        ...
        if (context instanceof Activity) {
            ...
            this.f646a = new WeakReference<>(null);
        }
        this.c = b4Var;
        this.o = c4Var;
        this.p = c4Var2;
    ...
    private ViewGroup l() {
        ...
        View a2 = w4.a(this.f646a.get(), this.d);
    ...
    /* access modifiers changed from: public */
    private boolean m() {
        Activity activity = this.f646a.get();
    ...
    class i extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            int k;
            if (this.f653a != null && "android.intent.action.CONFIGURATION_CHANGED".equals(intent.getAction()) && (k = d4.this.k()) != this.b) {
                d4.this.w = true;
                this.b = k;
                d4.this.a(k);
            }
    ...
    private void a(Runnable runnable) {
        ...
        View j2 = j();
        if (j2 != null) {
            this.g.a(this.d, j2).a(new g(j2, runnable));
        }
    }
