...
public class c {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x001b A[RETURN, SYNTHETIC] */
    ...
    public static void a(Activity activity, int i) {
        try {
            ...
            g.a(6, "Error to setRequestedOrientation ", e);
        }
    }
    ...
    public static void a(View view, final a aVar) {
        if (Build.VERSION.SDK_INT >= 11) {
            view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                /* class com.startapp.common.a.c.AnonymousClass1 */
    ...
    public static int f(Context context) {
        ...
        try {
            for (PackageInfo packageInfo : a(context.getPackageManager())) {
                if (!a(packageInfo) || packageInfo.packageName.equals(Constants.f563a)) {
                    i++;
                }
            }
        } catch (Exception e) {
    ...
    public static String j(Context context) {
        try {
            ...
            Arrays.sort(signatureArr, new Comparator<Signature>() {
                /* class com.startapp.common.a.c.AnonymousClass2 */
